...
const subcategories = [
  { subcategory: 'Fruits: Apples' },
  { subcategory: 'Fruits: Bananas' },
  { subcategory: 'Fruits: Oranges' },
  ...
  { subcategory: 'Meat: Pork' },
  { subcategory: 'Poultry: Chicken' },
  { subcategory: 'Seafood: Fish' },
  { subcategory: 'Seafood: Shrimp' },
  { subcategory: 'Seafood: Crab' },
  { subcategory: 'Beans: Black Beans' },
  { subcategory: 'Beans: Lentils' },
  { subcategory: 'Legumes: Chickpeas' },
  { subcategory: 'Nuts: Almonds' },
  { subcategory: 'Nuts: Cashews' },
  { subcategory: 'Seeds: Chia Seeds' },
  { subcategory: 'Oils: Olive Oil' },
  { subcategory: 'Oils: Coconut Oil' },
  { subcategory: 'Fats: Butter' },
  { subcategory: 'Sweets: Chocolate' },
  { subcategory: 'Sweets: Ice Cream' },
  { subcategory: 'Desserts: Cake' },
  { subcategory: 'Beverages: Coffee' },
  { subcategory: 'Beverages: Tea' },
  { subcategory: 'Beverages: Juice' }
]
